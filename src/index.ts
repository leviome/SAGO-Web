...
console.log(`SAGO Web v${appVersion} (based on SuperSplat 3.3.1) | SplatTransform v${stVersion} (${stRevision}) | Engine v${engineVersion} (${engineRevision}) | PCUI v${pcuiVersion} (${pcuiRevision})`);
