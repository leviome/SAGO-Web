...
class OrientTool {
    ...
    constructor(events: Events, scene: Scene, parent: HTMLElement, canvasContainer: Container, annotationParent: HTMLElement) {
        ...
        const alignButton = new Button({ id: 'orient-align-to-grid', class: 'select-toolbar-button', enabled: false });
        i18n.bindText(alignButton, 'orient.align');

        const clearButton = new Button({ id: 'orient-clear-points', class: 'select-toolbar-button', enabled: false });
